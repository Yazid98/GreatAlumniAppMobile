...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentHolder> {
    ...
    public class CommentHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Comment comment) {
            ...
            if (comment.getOwner_photo_url() != null) Picasso.get().load(comment.getOwner_photo_url()).placeholder(R.drawable.user_photo_holder).resize(ImageUtils.SIZE_L, ImageUtils.SIZE_L).into(bind.photo);
        }
    }
}
